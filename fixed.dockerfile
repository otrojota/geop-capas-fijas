...
# docker run --mount type=bind,source=/var/geoportal/fixed,target=/home/data --mount type=bind,source=/var/geoportal/fixed/publish,target=/home/publish otrojota/geoportal:capas-fijas-0.10
